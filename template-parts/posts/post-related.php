<div class="lg:flex lg:flex-col lg:justify-between lg:h-full pt-28 lg:pt-0 pb-28 lg:pb-0">
	...
	if ( $news_query->have_posts() ) :
		...
		while( $news_query->have_posts() ) :
			...
			?>
			<li>
				<a class="bg-blue-shade-3 transition-all duration-500 ease-in-out hover:bg-blue-shade-3 block rounded-[20px] overflow-hidden mb-6 lg:mb-0" href="<?php echo esc_url( get_the_permalink() ); ?>">
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'card-news card-news--related p-3   flex ' ); ?>>
						...
						if ( has_post_thumbnail() ) :
							...
							?><span class="min-w-[108px] lg:min-w-[135px] h-[108px] lg:h-[135px] bg-blue-shade-0 text-blue-shade-2 flex flex-col justify-center items-center rounded-[12px] font-poppins text-xs text-center">no featured image</span> <?php
						endif;
						?>
