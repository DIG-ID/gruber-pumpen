<div class="col-span-2 md:col-span-5 xl:col-span-7 xl:pb-16">
    ...
    <div class="w-full md:w-1/2 float-left">
        <?php
            if( have_rows('content_2_list_left_column') ):
                ...
                <h6 class="text-overline text-blue-shade-5 xl:max-w-[312px] mb-4 flex flex-row items-center"><span class="pr-[10px]"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/prefix.svg" alt="prefix" title="Prefix Icon" /></span><?php the_sub_field( 'title' ); ?></h6>
                <p class="text-p--2 xl:max-w-[312px] mb-12"><?php the_sub_field( 'text' ); ?></p>
        <?php   endwhile;
            endif; ?>
    </div>
    <div class="w-full md:w-1/2 float-left pl-5">
        <?php
...
<div class="col-span-2 md:col-span-6 xl:col-span-4 col-start-1 md:col-start-1 xl:col-start-9 xl:row-start-1 xl:row-span-2">
