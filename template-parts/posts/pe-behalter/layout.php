<section class="section-content-1 pt-10 md:pt-20 xl:pt-24 pb-0 xl:pb-0 overflow-hidden bg-blue-shade-0">
	<div class="theme-container theme-grid">
		<div id="content-1" class="col-span-2 md:col-span-6 xl:col-span-7 col-start-1 border-b border-blue-shade-2 pb-12 md:pb-7 xl:pb-12 order-1 xl:order-1">
		...
		<div id="gallery" class="col-span-2 md:col-span-6 xl:col-span-12 col-start-1 order-3 xl:order-3">
