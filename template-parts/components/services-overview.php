<section class="section-services py-8 xl:py-40 relative z-10">
		...
		if ($services_query->have_posts()) :
			while ($services_query->have_posts()) :
				...
				<div class="col-span-1 md:col-span-3 xl:col-span-3  md:bg-white md:px-9 xl:px-7 pt-6 pb-10 md:pt-10 md:pb-16 rounded-3xl">
					...
					<h3 class="text-title-h4 text-blue-shade-4 text-left mt-3 md:mt-6 mb-5 md:mb-6 "><?php the_field('title'); ?>
					</h3>
