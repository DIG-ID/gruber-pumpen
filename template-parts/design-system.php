...
<section class="flex justify-center items-center py-9 bg-brown-shade-2">
	<a class="btn-internal btn-internal--shade-1"  href="">button internal</a>
</section>
<section class="flex justify-center items-center py-9 bg-brown-shade-3">
	<a class="btn-internal btn-internal--shade-2"  href="">button internal</a>
</section>
<section class="flex justify-center items-center py-9 bg-brown-shade-4">
