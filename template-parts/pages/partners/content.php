				...
				while (have_rows('partners')):
					...
					<div
						...
						<div class="card-partner-content py-11 px-9 lg:py-16 lg:px-24">
							<h2 class="text-title-h3 text-blue-shade-3 mb-4"><?php the_sub_field('title'); ?></h2>
							<?php
							if (get_sub_field('description')):
								echo '<p class="text-body text-blue-shade-4 mb-6 lg:max-w-[414px]">' . get_sub_field('description') . '</p>';
							endif;
							...
							if ($tlink):
								...
								<a href="<?php echo esc_url($link_url); ?>"
									...
									<h3 class="text-body text-blue-shade-4 hover:transform-scale">
