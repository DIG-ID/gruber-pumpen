<section class="section-why-us py-28 px-12 overflow-hidden">
    <div class="theme-container relative flex flex-col gap-12 items-center ">
        ...
        if (have_rows('why_us_strengths')): ?>
            <div class="flex flex-wrap gap-24 mt-12 justify-center">
