<section class="section-homepage-info-bar bg-blue-shade-4 py-4 md:py-12 overflow-hidden">
    ...
    if (have_rows('general_info')):
        ...
        while (have_rows('general_info')):
            the_row(); ?>
            <div class="col-span-1 md:col-span-2 xl:col-span-3 flex flex-col gap-2 py-3 md:py-12 items-center border-[#688494] <?php echo $counter < $length ? 'md:border-r' : '' ?>">
                <div class="flex">
