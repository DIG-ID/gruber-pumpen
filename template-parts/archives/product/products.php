<section class="section-products">
	<div class="theme-container theme-grid">
				...
				if ( $products_query->have_posts() ) :
					while ( $products_query->have_posts() ) :
						...
						<div class="swiper-slide fade-in bg-white md:px-9 xl:px-7 pt-6 md:pt-10 pb-20 md:pb-32 mb-10 xl:mb-0 rounded-3xl">
							...
							<h3 class="text-title-h4 text-blue-shade-4 text-left mt-3 md:mt-6 mb-5 md:mb-6 px-4 md:px-0 fade-in"><?php the_title(); ?></h3>
		...
		<div class="col-span-2 md:col-span-6 xl:col-span-12 theme-grid block lg:hidden">
			<div class="col-span-2 md:col-span-6 xl:col-span-12 flex justify-start gap-x-4 mt-12">
