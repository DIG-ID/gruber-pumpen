	...
	<div class="theme-container theme-grid">
		...
		<div class="col-span-2 md:col-span-6 xl:col-span-12 flex flex-col">
			<div class="flex items-center gap-4 invisible fade-in">
				<?php
				$services_eyebrow = get_field('products_services_eyebrow', 'option');
				if ($services_eyebrow): ?>
			...
			<div class="flex items-center justify-between invisible fade-in">
				<?php
				$services_title = get_field('products_services_title', 'option');
				if ($services_title): ?>
				...
				<?php
				$services_link = get_field('products_services_link', 'option');
				if ($services_link):
