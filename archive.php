					...
					if ( 0 === $i ) :
						...
						<div class="card-news col-span-2 lg:col-span-8 bg-white rounded-[20px] overflow-hidden ">
							...
							if ( has_post_thumbnail() ) :
								...
								?>
								<span class="bg-brown-shade-1 w-full h-[275px] lg:h-[345px] flex justify-center items-center font-poppins text-brown-shade-2">no thumbnail</span>
								<?php
							endif;
							?>
							<div class="card-news-content min-h-[200px] px-14 pt-9">
								<a href="<?php the_permalink(); ?>" class="flex items-center gap-x-4 mb-6">
									<h2 class="text-title-h2 text-brown-shade-4"><?php the_title(); ?></h2>
								...
								<p class="text-body text-brown-shade-4"><?php echo esc_html( get_the_excerpt() ); ?></p>
							</div>
						</div>
						<?php
					else :
